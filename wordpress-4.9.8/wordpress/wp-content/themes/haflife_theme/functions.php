<?php
/**
 * HAFlife_theme functions and definitions
 *
...
if ( ! function_exists( 'haflife_theme_setup' ) ) :
	/**
	 ...
	 */
	function haflife_theme_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on HAFlife_theme, use a find and replace
		 * to change 'haflife_theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'haflife_theme', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'haflife_theme' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'haflife_theme_custom_background_args', array(
...
add_action( 'after_setup_theme', 'haflife_theme_setup' );
 ...
 */
function haflife_theme_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'haflife_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'haflife_theme_content_width', 0 );
 ...
 */
function haflife_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'haflife_theme' ),
		'id'            => 'sidebar-1',
...
add_action( 'wp_enqueue_scripts', 'haflife_theme_scripts' );
